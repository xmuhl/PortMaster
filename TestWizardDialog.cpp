...
void CTestWizardDialog::DoDataExchange(CDataExchange* pDX)
{
	...
	try
	{
		...
		DDX_Control(pDX, IDC_TRANSPORT_TYPE3, m_ctrlTransportType);
...
void CTestWizardDialog::InitializeControls()
{
	...
	// 初始化进度条
	m_ctrlTestProgress.SetRange32(0, 100);  // 使用SetRange32以保持一致性
