...
#### **优先级3：运行库配置** ⏳
**问题描述**：
- `PortMaster.vcxproj:66,98` 使用动态运行库 `/MDd` / `/MD`
- 分析报告第13.8节建议改为静态运行库

**解决方案**：
```xml
<!-- 在 PortMaster.vcxproj 中修改 -->
<!-- Debug 配置 -->
<RuntimeLibrary>MultiThreadedDebug</RuntimeLibrary>  <!-- 改为 /MTd -->

<!-- Release 配置 -->
<RuntimeLibrary>MultiThreaded</RuntimeLibrary>  <!-- 改为 /MT -->
```
